      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
          <div className="text-center mb-0">
            {/* <h1 className="text-3xl font-bold text-gray-900 mb-2">Vaulture</h1>
            <p className="text-gray-600">Vault + Secure</p> */}
            <div>
              <img src="logo.png" alt="" className='h-80 w-100' />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-semibold text-gray-900">Vaulture</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {!showPhotoUpload && !showPhotoGallery && (
          <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl shadow-sm border border-slate-200 p-10 text-center">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">Welcome to Vaulture</h3>
